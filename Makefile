...
#	CFLAGS      := -O2 -mno-shared -D_POSIX_C_SOURCE=200112L -flto -fprofile-generate
#	CXXFLAGS    := -O2 -mno-shared -D_POSIX_C_SOURCE=200112L -flto -fprofile-generate
...
#senquack
ALL_CFLAGS += -DGCWZERO -DENABLE_OPENGLES -I/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include
ALL_CXXFLAGS += -DGCWZERO -DENABLE_OPENGLES -I/opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/include
...
SDL_CPPFLAGS := $(shell /opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/bin/sdl2-config --cflags)
PNG_CPPFLAGS := $(shell /opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/bin/libpng-config --cflags)
...
SDL_LIBS := $(shell /opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/bin/sdl2-config --libs)
PNG_LIBS := $(shell /opt/gcw0-toolchain/usr/mipsel-gcw0-linux-uclibc/sysroot/usr/bin/libpng-config --libs)
